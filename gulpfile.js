...
elixir(function (mix) {
    ...
    mix.copy('bower_components/' + paths.bootstrap + '/fonts/bootstrap/**', 'public/fonts');
    mix.copy('bower_components/' + paths.fontawesome + '/fonts/**', 'public/fonts');

    // Copy images straight to public
    mix.copy('bower_components/' + paths.colorbox + '/example3/images/**', 'public/img');
    ...
    ], 'public/css/all.css', 'bower_components/');
